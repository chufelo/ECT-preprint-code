...
|:-:|---------|:-----------------:|:------:|:------:|:------:|------------------------------------------|-------|
| 1 | Status note (Level B; $\Delta H_0/H_0\approx 3\%$ closure-dependent) | opening paragraph | demote-to-appendix | content + argument-flow | relocate | **Appendix X2 only** (NOT §15.5.3 main text) | **Reclassified 2026-04-18 per user directive**: legacy per-phenomenon compensation numbers (3%, ε ≈ 0.010) not to appear in new §15.5 main text anywhere. Level B methodological status is covered in §15.5.1; the quantitative 3% illustrative value preserved only for Appendix X2 legacy discussion. |
| 2 | Bridge from age apparatus | `\paragraph{Bridge from the age apparatus.}` | reframe | argument-flow | rephrase | **§15.5.3 opening** (cross-ref to `\S\ref{sec:universe_age}` + `\S\ref{sec:mp_hubble}`) ✅ | Migrated at 2026-04-18. |
...
| 9 | BBN localisation of the Hubble mechanism | `\paragraph{BBN localisation...}` | demote-to-appendix | content + structural | relocate | **Appendix X2** (full argument) | **Reclassified 2026-04-18**: no specific legacy drift numbers in main text; methodological point (late-time localisation) handled at the §15.5.6 level as a scope statement only. |
...
| 11c | Statement: *"$\varepsilon=0.01$ ... is a late-time benchmark slope ... not an independently derived first-principles constant"* | same paragraph | **demote-to-appendix** | argument-flow | relocate | **Appendix X2 only** (NOT §15.5.3 main text) | **Reclassified 2026-04-18 per user directive**: specific value ε = 0.010 not to appear in new §15.5 main text. §15.5.3 Benchmark A retained as legacy label only; numerics preserved in Appendix X2. |
...
| 13 | **Benchmark numerical illustration** subsubsection + `fig:h0_scan` | `\subsubsection*{...}` + figure | **demote-to-appendix** | content + structural | relocate | **Appendix X2** (full derivation + fig:h0_scan) | **Reclassified 2026-04-18 per user directive**: 3% / ~2.8% / H₀ ≈ 69 km/s/Mpc numerics not to appear in new §15.5 main text. Figure label `fig:h0_scan` preserved in Appendix X2. |
...
| 14b | Robustness check numerics (2.90% vs 2.85% for mild deformation) | same subsubsection | **demote-to-appendix** | content | relocate | **Appendix X2** | **Reclassified 2026-04-18 per user directive**: 2.90% / 2.85% not in new §15.5 main text; preserved only in Appendix X2 legacy robustness discussion. |
