...
| 3 | Observational landscape (Planck + SH0ES + CCHP/Freedman numerics) | `\paragraph{Observational landscape.}` | reframe | content | rephrase | **§15.5.2 Probe 1 paragraph (partial)** | Planck2018 and Riess2022 numerics already reused in §15.5.2. **Freedman2024 (CCHP) sentence NOT yet reused — to add to §15.5.2 Probe 1 paragraph.** |
