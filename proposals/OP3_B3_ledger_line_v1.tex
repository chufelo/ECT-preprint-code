...
\date{12 June 2026 --- rev.~1.1 (review wording safeguard applied;
insertion authorised)}
...
entropy identity. The proposed L6 constrains the routing topology of the
post-onset conversion flow: which channel the conversion must use and in
which order the
