...
the ordered branch is available; they constrain OP3.3 but do not close it, and
...
bound~\eqref{eq:w_phi}; the first-pass ledger below is written for
the standard range $-1<w_{\rm pre}\le1$.
