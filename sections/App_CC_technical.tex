...
\begin{equation}
\det K^{AB} \;=\; g_{\mathrm{eff}} \;<\; 0\,,
\qquad
\sqrt{-g_{\mathrm{eff}}} \;=\; \sqrt{-\det K^{AB}} \;=\;
...
matching the linearised main-text relation $w_0 \simeq -1 +
2\rho_{\mathrm{kin}}/\rho_{\mathrm{cond}}$ upon identification
