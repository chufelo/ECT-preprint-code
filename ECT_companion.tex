...
Whether this route actually alleviates the observed lensing--growth
discrepancy remains open; it is a high-priority discriminator
rather than a current ECT result (\emph{Level~B/C}).
\end{enumerate}
