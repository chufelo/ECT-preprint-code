...
cosmological constant problem; cosmological-constant catastrophe resolution;
...
The \textbf{orientation modes} ($\delta n^A$): the symmetry breaking $O(4)/O(3) \simeq S^3$ naively admits three Goldstone directions, but integrability of the scalar-only basis reduces the propagating soft content to a single surviving longitudinal scalar mode~$\chi$ (see below). At the linearised level, the orientation sector generates the graviton (spin-2 mode).
...
\caption{Part~II derivation logic. From the ordered-branch EFT, the geometric branch produces all macroscopic results listed above. Colours indicate derivation levels. The updated Part~II derivation logic now separates the Level~A resolution of the direct cosmological-constant catastrophe from the distinct Level~C problem of the observed value of $\rho_\Lambda$.}
...
Wavefunction collapse & Postulate & Decoherence at $\Gamma_{\rm loop}\gg 1$ & B \\
...
Quantum gravity (UV completion) & Open problem & Graviton as condensate excitation governed by same $S_0$ & B/C \\
Measurement problem & Open problem & $\Gamma_{\rm loop}$ criterion + PES + conditional Born rule & B \\
\end{longtable}
...
structural Level~A resolution of the cosmological-constant
catastrophe together with the separate Level~C question of the
observed value of $\rho_\Lambda$. The reading of the
