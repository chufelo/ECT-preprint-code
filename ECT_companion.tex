...
\item \textbf{Vacuum stability.} The ordered condensate has $V''(u_0)>0$. In the Standard Model, the electroweak vacuum is metastable at $m_h=125$\,GeV (\emph{A}).
...
\item \textbf{Cosmological coincidence.} If dark energy is dynamical ($w_0\neq -1$), the near-equality $\Omega_m\sim\Omega_\Lambda$ may have a dynamical explanation through condensate evolution (\emph{B/Open}).
...
Vacuum stability & $V''(u_0)\!>\!0$ & A & Yes \\
