...
\item \textbf{The origin of quantum mechanics.} ECT provides a structural route to Hilbert space, superposition, and quantum dynamics from the condensate; the Born rule is conditionally unique via the RP/Gleason route but not yet fully first-principles derived (\emph{A/B}).
