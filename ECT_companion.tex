...
\textbf{Weak interaction (\emph{Level~B+}):} The residual rotation group $O(3)$ after $O(4) \to O(3)$ SSB is algebraically isomorphic to $SU(2)$ (as Lie algebras: $\mathfrak{so}(3) \cong \mathfrak{su}(2)$). The oriented condensate---through the sign of the four-volume form---selects one of the two $SU(2)$ factors of $Spin(4) \simeq SU(2)_+ \times SU(2)_-$, structurally selecting a single \emph{chiral} $SU(2)$ sector. This provides a structural route to weak-sector parity asymmetry---a feature postulated in the Standard Model acquires a geometric origin in ECT through the orientation of the ordered branch. The exactly maximally parity-violating Standard-Model pattern, however, remains an open derivation problem. The full derivation of the weak sector as an independent internal gauge field, however, remains open. The phenomenological realisation occurs through a secondary condensate scale at $v_2 \simeq 246$\,GeV, producing $W^\pm$, $Z$ bosons and electroweak symmetry breaking.
...
\item \textbf{Black-hole information paradox.} Fundamental information loss structurally forbidden (\emph{A}); Page curve reproduced (\emph{B}); general area-law entropy bound established (\emph{A/B}).
