...
sector, neutrino geometric masses, and cosmological-constant
fine-tuning as an acknowledged open problem. The reading of the
...
\item \textbf{The cosmological constant problem.} QFT predicts a vacuum scale that is enormously too large. ECT replaces a rigid external $\Lambda$ with dynamical condensate energy and thereby reframes part of the problem, but the residual $10^{-120}$ vacuum-scale fine-tuning is still open (\emph{B/Open}).
