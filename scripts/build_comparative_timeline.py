...
# ════════════════════════════════════════════════════════════════════════════
fig.suptitle(
    r'Illustrative comparative timeline under baseline-$H_0$ mapping'
    r' compatible with the retained five-probe band' '\n'
    r'NOW anchored at same point $\bullet$ '
    r'ECT younger by $\Delta t\approx340$ Myr $\bullet$ '
    r'Scen.~B: Big Crunch at $\sim10^{100}$ yr',
    fontsize=11, fontweight='bold', y=1.03)

fig.text(0.5, -0.09,
    'Note: schematic; epoch widths non-proportional. '
    'ECT resolves horizon, flatness, monopole problems without inflation (Level~A/B). '
