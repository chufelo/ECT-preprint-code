#!/usr/bin/env python3
"""Render the canonical main ECT derivation-map source."""
...
SOURCE = ROOT / "figures" / "source" / "graphviz" / "fig_ect_derivation_map.dot"
OUTPUT = ROOT / "figures" / "fig_ect_derivation_map.png"
