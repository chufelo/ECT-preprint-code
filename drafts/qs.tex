...
(already prepared in ECT basics; it vanishes on the diagonal $q=q'$)
and $\Gamma_{\rm irr}[q,q']\ge 0$ is the irreversibility functional
that suppresses off-diagonal contributions.
The normalisation by $S_0$---rather than a postulated $\hbar$---is
required by the internal consistency of the coherent branch:
...
The exact microscopic derivation for the full nonlinear coherent sector
remains open.
