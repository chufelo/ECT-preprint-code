...
**Current active work:** §15.5 rebuild, Phase 1 (parallel creation). §15.5.1–§15.5.4 integrated (PDF pp. 246–251). Next: drafting §15.5.5 (comparison with other approaches).
...
| 15.5.3 | Joint band + benchmark | **🟢 FINAL (GPT round 7+8 + user directive: no legacy numbers)** | **✅ integrated 2026-04-18 (PDF pp.249–250)** |
| 15.5.4 | Excluded probes | **🟢 FINAL (GPT round 9: 5 corrections)** | **✅ integrated 2026-04-18 (PDF pp.250–251)** |
| 15.5.5 | Comparison with other approaches | 🟡 next (short categorical; 1–2 refs per category max) | — |
