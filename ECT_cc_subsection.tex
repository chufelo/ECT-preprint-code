...
\end{equation}
and does not source local emergent gravitational dynamics. If $H_\Lambda$ fails,
...
term; see Sec.~\ref{subsec:Hlambda_cc} for details.
\end{description}
...
conditional on $H_\Lambda$. Neither feeds directly into Object~C in this sector.
